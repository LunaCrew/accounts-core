...
describe(':: Util :: Enum :: HttpStatusCode ::', () => {
  it('should return expected keys', () => {
    ...
    const keys = ['OK', 'CREATED', 'NO_CONTENT', 'BAD_REQUEST', 'UNAUTHORIZED', 'FORBIDEN', 'NOT_FOUND', 'INTERNAL_SERVER_ERROR', 'BAD_GATEWAY', 'SERVICE_UNAVAILABLE', 'CONNECTION_TIMED_OUT']
  ...
  it('should return expected values', () => {
    ...
    const values = ['200', '201', '204', '400', '401', '403', '404', '500', '502', '503', '522']
